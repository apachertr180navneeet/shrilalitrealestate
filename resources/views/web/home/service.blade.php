                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="property_item heading_space">
                                <div class="image">
                                    <img
                                        src="{{ asset('public/assets/web/images/property-listing-1.jpg') }}"
                                        alt="listin"
                                    ...
                                    <div class="overlay">
                                        <div class="centered">
                                            <a
                                                class="link_arrow white_border"
                                                href="{{ route('service.detail', ['id' => '1']) }}"
                                                >View Detail</a
                                            >
                                        </div>
                                    </div>
                                    ...
                                    <div class="property_meta">
                                        <span><i class="fa fa-object-group"></i>645 - 1149 sq.ft </span>
                                    </div>
                                </div>
                                ...
                                <div class="proerty_content">
                                    <div class="proerty_text">
                                        <h3>
                                            <a href="{{ route('service.detail', ['id' => '1']) }}">Shree Om Enclave</a
                                            >
                                        </h3>

                                        <span class="bottom10">KH NO 1/20, Gram pal, Near Jodhpur Resort, Vaishali Township, Jhanwar Road, Jodhpur 342008 - Rajisthan</span>
