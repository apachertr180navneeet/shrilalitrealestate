...
<section class="rev_slider_wrapper">
    <div id="rev_slider_3" class="rev_slider" data-version="5.0">
        <ul>
            <!-- SLIDE  -->
            <li>
                <img src="{{ asset('public/assets/web/images/banner-4.jpg') }}" alt="" data-bgposition="center center" data-bgfit="cover"
                    class="rev-slidebg">
            ...
            <!-- SLIDE  -->
            <li>
                <img src="{{ asset('public/assets/web/images/banner-7.jpg') }}" alt="" data-bgposition="center center" data-bgfit="cover"
                    class="rev-slidebg">
            ...
            <!-- SLIDE  -->
            <li>
                <img src="{{ asset('public/assets/web/images/banner-8.jpg') }}" alt="" data-bgposition="center center" data-bgfit="cover"
                    class="rev-slidebg">
                <div class="tp-caption  tp-resizeme" data-x="left" data-hoffset="-80" data-y="top" data-voffset="300"
                    data-transform_idle="o:1;"
                    data-transform_in="x:[-175%];y:0px;z:0;rX:0;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0.01;s:3000;e:Power3.easeOut;"
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-sm-5 col-xs-12">
                <div class="about-sev-img">
                    <img src="{{ asset('public/assets/web/images/about.png') }}" alt="image">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="property_item mb-5">
                    <div class="image">
                        <img src="{{ asset('public/assets/web/images/property-listing-1.jpg') }}" alt="listin" class="img-responsive">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="property_item mb-5">
                    <div class="image">
                        <img src="{{ asset('public/assets/web/images/property-listing-2.jpg') }}" alt="listin" class="img-responsive">
                        <div class="property_meta">
                            <span><i class="fa fa-object-group"></i>530 sq ft </span>
                            <span><i class="fa fa-bed"></i>2</span>
                            <span><i class="fa fa-bath"></i>1 Bathroom</span></div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="property_item mb-5">
                    <div class="image">
                        <img src="{{ asset('public/assets/web/images/property-listing-3.jpg') }}" alt="listin" class="img-responsive">
                        <div class="property_meta">
                            <span><i class="fa fa-object-group"></i>530 sq ft </span>
                            <span><i class="fa fa-bed"></i>2</span>
                            <span><i class="fa fa-bath"></i>1 Bathroom</span></div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="property_item mb-5">
                    <div class="image">
                        <img src="{{ asset('public/assets/web/images/property-listing-4.jpg') }}" alt="listin" class="img-responsive">
                        <div class="property_meta">
                            <span><i class="fa fa-object-group"></i>530 sq ft </span>
                            <span><i class="fa fa-bed"></i>2</span>
                            <span><i class="fa fa-bath"></i>1 Bathroom</span></div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="property_item mb-5">
                    <div class="image">
                        <img src="{{ asset('public/assets/web/images/property-listing-5.jpg') }}" alt="listin" class="img-responsive">
                        <div class="property_meta">
                            <span><i class="fa fa-object-group"></i>530 sq ft </span>
                            <span><i class="fa fa-bed"></i>2</span>
                            <span><i class="fa fa-bath"></i>1 Bathroom</span></div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="property_item mb-5">
                    <div class="image">
                        <img src="{{ asset('public/assets/web/images/property-listing-6.jpg') }}" alt="listin" class="img-responsive">
                        <div class="property_meta">
                            <span><i class="fa fa-object-group"></i>530 sq ft </span>
                            <span><i class="fa fa-bed"></i>2</span>
                            <span><i class="fa fa-bath"></i>1 Bathroom</span></div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 padding-left-0 project-images">
                        <div class="gri">
                            <figure class="effect-layla">
                                <img src="{{ asset('public/assets/web/images/b-d-property.jpg') }}" alt="img" />
            ...
            <div class="item">
                <div class="project1">
                    <div class="col-md-12 col-sm-12 col-xs-12 padding-left-0 project-images">
                        <div class="gri">
                            <figure class="effect-layla">
                                <img src="{{ asset('public/assets/web/images/b-d-property-2.jpg') }}" alt="img" />
                                <figcaption> </figcaption>
                            </figure>
                        </div>
                        <div
    ...
    <div class="container">
        ...
        <div class="row mt-5">
            <div class="col-lg-3 col-md-4 col-sm-6 text-center">
                <div class="team-box">
                    <img src="{{ asset('public/assets/web/images/team-1.png') }}" alt="img">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 text-center">
                <div class="team-box">
                    <img src="{{ asset('public/assets/web/images/team-2.png') }}" alt="img">
                    <h2>Amy Hawman</h2>
                    <p>VP Product</p>
                    <ul>
                        <li><a href="#"><i class="fa-brands fa-linkedin-in"></i></a></li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 text-center">
                <div class="team-box">
                    <img src="{{ asset('public/assets/web/images/team-3.png') }}" alt="img">
                    <h2>Anita Kutlesa</h2>
                    <p>VP Product</p>
                    <ul>
                        <li><a href="#"><i class="fa-brands fa-linkedin-in"></i></a></li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 text-center">
                <div class="team-box">
                    <img src="{{ asset('public/assets/web/images/team-4.png') }}" alt="img">
                    <h2>Antonios Garnelis</h2>
                    <p>VP Product</p>
                    <ul>
                        <li><a href="#"><i class="fa-brands fa-linkedin-in"></i></a></li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 text-center">
                <div class="team-box">
                    <img src="{{ asset('public/assets/web/images/team-5.png') }}" alt="img">
                    <h2>Amy Hawman</h2>
                    <p>VP Product</p>
                    <ul>
                        <li><a href="#"><i class="fa-brands fa-linkedin-in"></i></a></li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 text-center">
                <div class="team-box">
                    <img src="{{ asset('public/assets/web/images/team-6.png') }}" alt="img">
                    <h2>Anita Kutlesa</h2>
                    <p>VP Product</p>
                    <ul>
                        <li><a href="#"><i class="fa-brands fa-linkedin-in"></i></a></li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 text-center">
                <div class="team-box">
                    <img src="{{ asset('public/assets/web/images/team-7.png') }}" alt="img">
                    <h2>Antonios Garnelis</h2>
                    <p>VP Product</p>
                    <ul>
                        <li><a href="#"><i class="fa-brands fa-linkedin-in"></i></a></li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 text-center">
                <div class="team-box">
                    <img src="{{ asset('public/assets/web/images/team-8.png') }}" alt="img">
                    <h2>Antonios Garnelis</h2>
                    <p>VP Product</p>
                    <ul>
                        <li><a href="#"><i class="fa-brands fa-linkedin-in"></i></a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="latest_page_box">
                    <div class="news_image">
                        <img src="{{ asset('public/assets/web/images/nav-slider3.jpg') }}" alt="image">
                        <div class="price">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="latest_page_box">
                    <div class="news_image">
                        <img src="{{ asset('public/assets/web/images/nav-slider1.jpg') }}" alt="image">
                        <div class="price">
                            <span class="tag_red">26</span>
                            <span class="tag_white">MAR</span>
                        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="latest_page_box">
                    <div class="news_image">
                        <img src="{{ asset('public/assets/web/images/nav-slider2.jpg') }}" alt="image">
                        <div class="price">
                            <span class="tag_red">26</span>
                            <span class="tag_white">MAR</span>
                        </div>
