  ...
  <div class="container">
    <div id="projects" class="cbp">
      <div class="cbp-item latest rent">
        <div class="image">
           <img src="{{ asset('public/assets/web/images/project1.jpg') }}" alt="">
           <div class="overlay">
              <a href="{{ asset('public/assets/web/images/project1.jpg') }}" class="fancybox centered" data-fancybox-group="gallery">
