        ...
        <div class="row">
          <div class="col-md-12">
            <div id="property-d-1" class="owl-carousel">
              <div class="item"><img src="{{ asset('assets/web/images/property-d-1-1.jpg') }}" alt="image" /></div>
              <div class="item"><img src="{{ asset('assets/web/images/property-d-1-1.jpg') }}" alt="image" /></div>
              <div class="item"><img src="{{ asset('assets/web/images/property-d-1-1.jpg') }}" alt="image" /></div>
              <div class="item"><img src="{{ asset('assets/web/images/property-d-1-1.jpg') }}" alt="image" /></div>
              <div class="item"><img src="{{ asset('assets/web/images/property-d-1-1.jpg') }}" alt="image" /></div>
            ...
            <div id="property-d-1-2" class="owl-carousel">
              <div class="item"><img src="{{ asset('assets/web/images/property-d-s-1-1.jpg') }}" alt="image" /></div>
              <div class="item"><img src="{{ asset('assets/web/images/property-d-s-1-1.jpg') }}" alt="image" /></div>
              <div class="item"><img src="{{ asset('assets/web/images/property-d-s-1-1.jpg') }}" alt="image" /></div>
              <div class="item"><img src="{{ asset('assets/web/images/property-d-s-1-1.jpg') }}" alt="image" /></div>
              <div class="item"><img src="{{ asset('assets/web/images/property-d-s-1-1.jpg') }}" alt="image" /></div>
